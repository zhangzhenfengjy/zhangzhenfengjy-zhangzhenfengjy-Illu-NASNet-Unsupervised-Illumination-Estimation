...
def LSregressDiffSpec(diff, spec, imOrig, diffOrig, specOrig ):
    ...
    renderedImg = renderedImg.contiguous().view(nb, -1)
    imOrig = imOrig.contiguous().view(nb, -1)
...
class encoderLight(nn.Module ):
    def __init__(self, SGNum):
        ...
        self.preProcess = nn.Sequential(
                ...
                nn.Conv2d(in_channels=3, out_channels=32, kernel_size=4, stride=2, bias =True),
